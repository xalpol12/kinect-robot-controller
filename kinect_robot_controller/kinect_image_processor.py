...
class KinectImageProcessor(Node):
    def __init__(self):
        ...
        self.depth_window.create_trackbar("threshold", MIN_THRESHOLD_TRACKBAR_VALUE, 
                                          MAX_THRESHOLD_TRACKBAR_VALUE, on_detection_threshold_change)
    ...
    def rgbd_callback(self, rgbd_image: Image):
        ...
        _, self.threshed_depth_image = cv2.threshold(self.depth_image, DEPTH_DETECTION_THRESHOLD, 
                                                     255, cv2.THRESH_BINARY_INV)
        self.update_windows()
        print(DEPTH_DETECTION_THRESHOLD)
